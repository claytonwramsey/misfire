...
use misfire_sys::EnumSharedMemoryServerStatus::{
...
impl PhysicsClient {
    ...
    /// ```rust
    /// use misfire::ChangeDynamicsOptions;
    /// ChangeDynamicsOptions {
    ...
    /// For Example:
    /// ```rust
    ///# use misfire::{ControlCommand, PhysicsClient, Mode};
    ///# use anyhow::Result;
    ///# pub fn main() -> Result<()> {
    ///#     let mut client = PhysicsClient::connect(Mode::Direct)?;
    ///#     client.set_additional_search_path("../misfire-sys/bullet3/libbullet3/examples/pybullet/gym/pybullet_data")?;
    ...
    /// ```no_run
    ///# use anyhow::Result;
    ///# use misfire::Mode::Gui;
    ///# use misfire::AddDebugLineOptions;
    ///# use misfire::PhysicsClient;
    ///# use std::time::Duration;
    ///#
    ///# pub fn main() -> Result<()> {
    ...
    ///# use anyhow::Result;
    ///# use misfire::Mode::Gui;
    ///# use misfire::AddDebugTextOptions;
    ///# use misfire::PhysicsClient;
    ///# use std::time::Duration;
    ///# use nalgebra::Vector3;
    ///# pub fn main() -> Result<()> {
    ...
    /// ```no_run
    ///# use anyhow::Result;
    ///# use misfire::{LoggingType, StateLoggingOptions, PhysicsClient, Mode};
    ///# fn main() -> Result<()> {
    ///#     let mut  physics_client = PhysicsClient::connect(Mode::Gui)?;
